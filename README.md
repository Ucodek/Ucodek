# Hi there, I'm Umut Kaya 👋

### 🎓 Computer Engineering Student | AI Researcher | Automation Enthusiast

I am a 4th-year Computer Engineering student at **Abdullah Gül University (AGÜ)**, dedicated to building intelligent systems and solving complex problems through code. My expertise lies in **Deep Reinforcement Learning**, **Computer Vision**, and **Workflow Automation**.

---

### 🚀 Technical Highlights
- **Financial AI:** Developing DRL agents (PPO, A2C) for advanced financial portfolio optimization.
- **Computer Vision:** Author of "Enhancing Fire and Smoke Detection with YOLOv8" (presented at UBMK 2025).
- **Automation & Scraping:** Building intelligent bots and data pipelines using **n8n**, **Python**, and **Selenium**.
- **Digital Solutions:** Designing QR-based systems and full-stack applications for real-world impact.
